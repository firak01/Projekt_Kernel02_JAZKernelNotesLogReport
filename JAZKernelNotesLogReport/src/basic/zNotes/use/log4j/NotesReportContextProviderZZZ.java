...
/**Klasse erweitert den KernelReportContextProviderZZZ um die Konfigurationen, die f�r das Schreiben in NotesDatenbanken notwendig sind.
 * Die f�r alle Notes-Contexte notwendigen Informationen werden aus dem NotesContextProvider geholt.
...
public class NotesReportContextProviderZZZ extends KernelReportContextProviderZZZ implements IKernelNotesZZZ{
	...
	private String sLog4jPathTemp=null; //Der Pfad der "cachenden" Log4j - Dateien. Wert f�r: //f�r "log4j.appender.NOTESLOGGER.File=@@FILENAMENOTES@@\n"
	private String sLog4jFileTemp=null;
	//private String sLog4jLevel=null;     //Der Wert f�r @@LEVEL@@ in: "log4j.rootLogger=@@LEVEL@@, ROLL, NOTESLOGGER\n"
	//private String sLog4jDBApplicationLog=null; // f�r log4j.appender.NOTESLOGGER.notesDb=@@DBApplicationLog@@\n"
	//private String sLog4jServer=null; //                f�r log4j.appender.NOTESLOGGER.dominoServer=@@DBServer@@n"
    private String sFlagReplication=null; //            f�r log4j.appender.NOTESLOGGER.flagReplication=@@FlagReplication@@
...
//	################################		
	...
	// FGL Erweiterung: Parmeter aus der ini Auslesen. Merke: Dies sind Parmeter, die zus�tzlich zum NotesContextProviderZZZ definiert wurden
//	##################### GETTER /SETTER

		/** Der Dateipfad f�r die log4jProtokolle, die dann sp�ter gesammelt in ein NotesDokument geschrieben werden sollen. Wird als Parameter aud der Ini-Datei ausgelesen
		* @return String
